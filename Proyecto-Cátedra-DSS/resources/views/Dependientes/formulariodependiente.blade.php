                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form >
                            ...
                            <div class="text-end">
                            <a href="" class="btn btn-primary me-md-2 mb-2 mb-md-0" role="button">Realizar Transacción</a>
                            <a href="#" class="btn btn-secondary me-md-2 mb-2 mb-md-0" role="button" >Cancelar</a>
                            </div>
                        </form>
                    </div>
                </div>
