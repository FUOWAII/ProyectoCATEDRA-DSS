...
<head>
    ...
    .navbar-nav {
        margin-right: auto; /* Empuja los elementos de la barra de navegación a la izquierda */
        margin-left: auto; /* Empuja los elementos de la barra de navegación a la derecha */
    }
    /* Ajuste para separar el botón de inicio de sesión */
    .ml-auto {
        margin-right: 10px; /* Ajusta el margen derecho del botón de inicio de sesión */
    }
    </style>
</head>
<body>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="btn-group d-flex justify-content-center" role="group" aria-label="Botones de acción">
                    <a href="{{ route('formulariodependiente') }}" class="btn btn-primary mr-2" role="button">Realizar Transacciones</a>
                    <a href="{{ route('ingresodependiente') }}" class="btn btn-primary mr-2" role="button">Consultar Cuentas</a>
                    <a href="{{ route('listadependientesucursal') }}" class="btn btn-primary mr-2" role="button">Ver transacciones</a>
                    <a href="{{ route('welcome') }}" class="btn btn-primary" role="button">Cerrar Sesión</a>
                </div>
            </div>
        </div>
    </div>
