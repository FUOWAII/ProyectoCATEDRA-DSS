...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('css/cuentabancaria.css') }}">
  </head>
  ...
  <body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <form>
        <div style="text-align: center;" class="form-text">
            <img class="mb-3" src="https://upload.wikimedia.org/wikipedia/commons/6/60/Banco-agricola-sv-logo.jpg" alt="Logo del Banco" width="300" height="57">
            <h1 class="h3 mb-3 fw-normal" style="font-size: 1.2rem; letter-spacing: 1px;">Por favor, inicia sesión</h1>
        </div>
        ...
        <div class="form-floating form-text">
            ...
            <small style="font-size: 1rem; letter-spacing: 1px;">Ingrese su número de cuenta de 8 dígitos.</small>
        </div>
        <br>
        <div class="form-floating form-text">
            <input type="password" class="form-control" id="balance" name="balance" required >
            <label for="balance" >Contraseña</label>
            <small style="font-size: 1rem; letter-spacing: 1px;">Ingrese la contraseña de la cuenta.</small>
        </div>
